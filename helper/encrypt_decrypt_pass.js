...
function custom_jwt(payload, type, origin = 'Super') {
    let lower = "0123456789/abcdefghijklmnopqrstuvwxyz".split("");
    let upper = "0123456789/ABCDEFGHIJKLMNOPQRSTUVWXYZ".split("");
...
module.exports = { hashPassword, checkPassword, custom_jwt  }